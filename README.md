...
- **Feyree EV Charger** (Tuya-based) with **WBR3 module**
- **Replacement WBR3 module** (ESP8266-based, Tuya compatible) - if not already replaced
- **Torx screwdriver set** (for opening the charger enclosure)
